...
function View({cupid}) {
  ...
  return (
    <>
    {cupboards.length>0 &&
    <Card title={<Flex justify='space-between'><div>Cupboard - {cupboards[0].cupboardId} - {cupboards[0].cupboardName}</div><div> No of books: {cupboards[0].remain+cupboards[0].borrowed}</div></Flex>}>
